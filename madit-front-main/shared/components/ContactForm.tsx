        ...
        <div className="container-width">
          ...
          <div className="section-wrapper">
            <div className="contact-form__image">
              {contactImageUrl && <Image src={contactImageUrl} alt="Contact MADIT" width={1300} height={910} quality={100} sizes="(max-width: 768px) 100vw, 50vw" style={{ width: '100%', height: 'auto' }} />}
            </div>
            {successful ? (
